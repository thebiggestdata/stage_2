package com.thebiggestdata.infrastructure.adapter.out.serializer;

import com.thebiggestdata.domain.exception.InvalidBookContentException;
...
public class BookSerializer {
    ...
    public Book serialize() {
        if (!isValidBook(bookContent)) {
            throw new InvalidBookContentException(bookId, "Invalid book markers");
        }
        return new Book(
                bookId,
                extractHeader(),
