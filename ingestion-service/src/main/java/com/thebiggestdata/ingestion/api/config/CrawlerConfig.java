package com.thebiggestdata.ingestion.api.config;
...
public class CrawlerConfig {
    ...
    public CrawlerController crawlerController() {
        com.thebiggestdata.ingestion.control.utils.CrawlerConfig config = new com.thebiggestdata.ingestion.control.utils.CrawlerConfig(1, 1000, 1000L);
